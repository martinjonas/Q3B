...
(assert
 ...
 (bvsle (bvadd (bvmul (_ bv2 32) c_main_~ielen~6) c_main_~p~6) (bvadd c_main_~bufsize_0~6 (_ bv6 32)))))
(assert
 (not
 (and (bvsle (bvadd (bvmul (_ bv2 32) c_main_~ielen~6) c_main_~p~6) (bvadd c_main_~bufsize_0~6 (_ bv6 32)))
 (bvsle (_ bv2 32) c_main_~i~6)
 (exists ((main_~ielen~6 (_ BitVec 32)))
  (and (bvsle (_ bv4 32) main_~ielen~6)
  (bvsle (bvadd (bvmul (_ bv2 32) main_~ielen~6) c_main_~p~6) (bvadd c_main_~bufsize_0~6 (_ bv6 32)))))
 (bvsle (_ bv3 32) c_main_~i~6))))
(check-sat)
(exit)
